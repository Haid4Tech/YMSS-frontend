...
import { SignUpType, AuthSession } from "@/jotai/auth/auth-types";
...
export default function Page() {
  ...
  const authResult = useAtomValue(authPersistedAtom) as AuthSession | null;
  const setSignUpFormData = useSetAtom(signupFormAction);
  const [, triggerSignUp] = useAtom(signUpTriggerAtom);
  ...
  // useEffect(() => {
  //   if (signInStatus.state === "hasData" && authResult) {
  ...
  //   }
  // }, [signInStatus.state, authResult, router]);
